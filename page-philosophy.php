...
<main>
    ...
    <section class="philosophy-content" data-midnight="default">
        <div class="philosophy-content__inner inner">
            ...
            <div class="philosophy-content-text-bottom">
                ...
                <div class="philosophy-content-text-bottom-text">
                    私たちは、不動産業界という未完成のフィールドで、ときには「人」と「不動産」の枠を越え、<br>
                    まだ誰も知らない「より幸せな関係」
                    を探求する冒険に挑んでいます。<br>
                </div>
                <div class="philosophy-content-text-bottom-text">
                    変化し続ける世界で問いを抱き、
                    進化を重ね、50年後、100年後の未来に、豊かで美しい社会を手渡すこと。
                </div>
                <div class="philosophy-content-text-bottom-text">
                    それが私たちの理念です。
                </div>
    ...
    <!-- philosophy-rules -->
    <section class="philosophy-rules-text" data-midnight="default">
