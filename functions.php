...
{ 
    ...
    // GSAPの読み込み（header-scrollの前に読み込む必要がある）
    ...
    // midnight.jsは削除し、新しいheader-scroll.jsを使用
    wp_enqueue_script('header-scroll', get_theme_file_uri('/js/header-scroll.js'), array('jquery', 'gsap-scroll-trigger'), '1.0.0', true);
